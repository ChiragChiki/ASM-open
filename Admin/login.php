...
<body>
 ...
 <div class="jumbotron Admin-img-login" style="background-image:url(../images/mustang.jpg);">
 <div class="text-center mt-2 text-white" style="font-size: 30px;">
 <i class="fas fa-user-secret text-danger"></i>
    <span>ASM Login</span>
    <p class="ml-5" style="font-size: 12px;"> <span>Admin Area(Demo)</span>
  </div>
  ...
  <i class="fas fa-user text-danger"></i><label for="email" class="font-weight-bold text-white">Email</label>
    <input type="text" class="form-control opacity" name="aEmail" placeholder="Email">
</div>
<div class="form-group">
  <i class="fas fa-key text-danger"></i><label for="password" class="font-weight-bold text-white">Password</label>
    <input type="password" class="form-control opacity" name="aPassword" placeholder="Password">
</div>
